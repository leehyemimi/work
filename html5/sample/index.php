...
<head>
	...
	if (!$g['mobile'] || $_SESSION['pcmode'] == 'Y') {
		echo '<link rel="stylesheet" href="../cssjs/css/pc_style.css">';
	} else {
		echo '';
	}
	?>
	<link rel="stylesheet" href="./cssjs/css/ui.css"><!--각 책마다 css 변경 -->
	<link rel="shortcut icon" href="/_core/images/ico/champstudy/favicon.ico">
...
<div class="intro content active">
	<div class="section">
		<a href="javascript:js_show('guide');">
			<img src="//gscdn.hackers.co.kr/champ/img/contents/shadowing/NewTEPSBasicListening/main.png" alt="" >
		</a>
	</div>
</div d>
<!--//메인-->
...
<div class="guide content">
	<h1>프로그램 활용법</h1>
	<p class="img_guide">
		<img src="//gscdn.hackers.co.kr/champ/img/contents/shadowing/NewTEPSBasicListening/img_guide.png" alt="">
	</p>
	<div class="guide_txt">
...
<div class="index content">
	...
	<div id="content">
		...
		<!--문제-->
		<div class="test-wrap" id="question-box">
			<div class="path"></div>
			<dl class="status">
				<dt>문항 : </dt>
			...
			<div class="audio" id="audio">
				...
				<div class="btn">
					<div id="pronunc-list" class="pronunc-list">
						<a href="#;" class="text active"><em></em> 발음</a>
						<ul></ul>
					</div>
					<button type="button" class="toggle hidden" id="script-btn">스크립트 보이기</button>
				</div>
			</div>


			<!--문제풀기-->
			<div class="txt-area" id="question-area">
			...
			<!--정답맞추기-->
			<div class="txt-area hidden" id="answer-area">
				<h3>정 답</h3>
			...
			<!--스크립트-->
			<div class="txt-area hidden" id="script-area">
				<div id="script-area-text">
