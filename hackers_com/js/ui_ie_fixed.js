...
$(document).ready(function(){
	...
	$(".business_layer").css("height",layer_h - 50);
    ...
    $(window).resize(function() {
		...
		var layer_h1 = $(window).height();
    	$(".business_layer").css("height",layer_h - 50);
		$(".business_layer").css("top", layer_h1 * 2);
	...
	$('#tmenu a').click(function(e){
		...
		imsi2 = parseInt($(this).attr('class').slice(1,2));
		temp = imsi2;
		...
		$(".wrap").animate({
			...
			if(imsi2 == 2){ //  imsi1 == n1 , slide-2일 경우
		...
		$('body').removeClass();
		$('body').addClass("active-slide-"+ imsi2);
		$('body').addClass("active-nth-slide-"+ imsi2);
		...
		$('html, body').stop().animate({scrollTop: _top },400,'jswing', function() {
			$('#tmenu li').removeClass("on");
			el.parent().addClass('navi-' + $className);
